            ...
            <html>
                <head>
                    ...
                    <link type='text/css' rel='stylesheet' href='style.css'/>
                     <link href='http://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'><title>Poller</title>
                </head>
                <body>
                    <h1>" . $frage . "</h1>
...
elseif(!empty($_POST['antwort'])):
    ...
    $output .= "<p>Die Ergebnisse können erst ab 5 Stimmen angezeigt werden</a></body></html>";
    }
    echo $output;
else:
    echo "Fehler beim Neuladen der Seite.";
endif;
